        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {problems.map((problem, index) => (
            <tr key={index} className="">
              <td className="px-4">
                <div className="-16">{showDifficulty && <img src={`${process.env.PUBLIC_URL}/tier/${problem.difficulty}-sample.png`} alt={problem.difficulty} className="object-cover h-10 w-auto" />}</div>
              </td>
